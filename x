(this was my method before homebrew created a native arm64 bottle for root late 2025)
DEPENDENCIES:
amd64 architicture: I found that putting <arch -x86_64 > before the official homebrew install command gets the job done ;)
echo "base tools"
